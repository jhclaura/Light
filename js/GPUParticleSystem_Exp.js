...
THREE.GPUParticleContainer = function(maxParticles, particleSystem) {
  ...
  for (var i = 0; i < self.PARTICLE_COUNT; i++) {
    self.particlePositionsStartTime[i * 4 + 0] = 0; //x, 100  
    ...
    self.particleVelColSizeLife[i * 4 + 0] = decodeFloat(Math.floor(Math.random()*254-128), Math.floor(Math.random()*254-128), Math.floor(Math.random()*254-128), 0); //vel, decodeFloat(128, 128, 0, 0)
